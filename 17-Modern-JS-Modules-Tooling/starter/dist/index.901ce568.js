...
// console.log(price);
// Exporting module
console.log("Exporting Module");const l=[];function s(t,n){l.push({product:t,quanity:n}),console.log(`${n} ${t} added to the cart`)}var p=/**
 * @license
